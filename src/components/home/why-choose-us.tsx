...
const features = [
  {
    icon: Shield,
    title: 'Vet Approved',
    description: 'All products are recommended and approved by veterinary professionals',
  },
  {
    icon: Heart,
    title: 'Pet Parent Tested',
    description: 'Real pet parents test and review every product before we sell it',
  },
  {
    icon: Truck,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            We're more than just a pet store - we're your partner in providing the best care for
            your furry family.
          </p>
        </div>
